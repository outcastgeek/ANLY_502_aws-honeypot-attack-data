...
The [Insight into the Complaints] is as follows:
...
```{r mowerUnitSalesDataTags, echo=FALSE}
```
...
The [Defects after Delivery for years 2010, 2011, 2012, 2013 and 2014] is as follows:

```{r defectsAfterDelivery, echo=FALSE}
```

### Step 8: (Response Time)

The [Response Times for Q1, Q2, Q3, Q4 for years 2013 and 2014] is as follows:

```{r responseTime, echo=FALSE}
```
...
The most recent data available is from 2014, so the monthly [Realtime Sales Dashbord] is as follows:
...
```{r mowerUnitSalesDataTags, eval=FALSE}
```
...
### Defects after Delivery for years 2010, 2011, 2012, 2013 and 2014:

```{r defectsAfterDelivery, eval=FALSE}
```

### Response Times for Q1, Q2, Q3, Q4 for years 2013 and 2014

```{r responseTime, eval=FALSE}
```

### Realtime Sales Dashbord
